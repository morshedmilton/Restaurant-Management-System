...
public class Nagad extends JFrame implements MouseListener, ActionListener{
	...
	ImageIcon icon2 = new ImageIcon ("images/nagad1.jpg");
	customer c;
	customers cs;
	...
	public Nagad(customers cs){
		...
		bkashLabel.setBounds(400,140,200,100);
		panel.add(bkashLabel);
		
		paymentLabel = new JLabel("Nagad Payment"); 
		...
		closeBtn.setBounds(590,420, 100, 40);
